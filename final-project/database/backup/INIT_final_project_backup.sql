...
CREATE TABLE `images` (
  ...
  UNIQUE KEY `fileName_19` (`fileName`),
  UNIQUE KEY `fileName_20` (`fileName`),
  UNIQUE KEY `fileName_21` (`fileName`),
  UNIQUE KEY `fileName_22` (`fileName`),
  UNIQUE KEY `fileName_23` (`fileName`),
  UNIQUE KEY `fileName_24` (`fileName`),
  UNIQUE KEY `fileName_25` (`fileName`),
  UNIQUE KEY `fileName_26` (`fileName`),
  UNIQUE KEY `fileName_27` (`fileName`),
  UNIQUE KEY `fileName_28` (`fileName`),
  UNIQUE KEY `fileName_29` (`fileName`),
  UNIQUE KEY `fileName_30` (`fileName`),
  UNIQUE KEY `fileName_31` (`fileName`),
  UNIQUE KEY `fileName_32` (`fileName`),
  UNIQUE KEY `fileName_33` (`fileName`),
  UNIQUE KEY `fileName_34` (`fileName`),
  UNIQUE KEY `fileName_35` (`fileName`),
  UNIQUE KEY `fileName_36` (`fileName`),
  UNIQUE KEY `fileName_37` (`fileName`),
  UNIQUE KEY `fileName_38` (`fileName`),
  UNIQUE KEY `fileName_39` (`fileName`),
  UNIQUE KEY `fileName_40` (`fileName`),
...
CREATE TABLE `locations` (
  ...
  UNIQUE KEY `description_19` (`description`),
  UNIQUE KEY `description_20` (`description`),
  UNIQUE KEY `description_21` (`description`),
  UNIQUE KEY `description_22` (`description`),
  UNIQUE KEY `description_23` (`description`),
  UNIQUE KEY `description_24` (`description`),
  UNIQUE KEY `description_25` (`description`),
  UNIQUE KEY `description_26` (`description`),
  UNIQUE KEY `description_27` (`description`),
  UNIQUE KEY `description_28` (`description`),
  UNIQUE KEY `description_29` (`description`),
  UNIQUE KEY `description_30` (`description`),
  UNIQUE KEY `description_31` (`description`),
  UNIQUE KEY `description_32` (`description`),
  UNIQUE KEY `description_33` (`description`),
  UNIQUE KEY `description_34` (`description`),
  UNIQUE KEY `description_35` (`description`),
  UNIQUE KEY `description_36` (`description`),
  UNIQUE KEY `description_37` (`description`),
  UNIQUE KEY `description_38` (`description`),
  UNIQUE KEY `description_39` (`description`),
  UNIQUE KEY `description_40` (`description`),
  UNIQUE KEY `description_41` (`description`),
  UNIQUE KEY `description_42` (`description`),
...
CREATE TABLE `plugins` (
  ...
  UNIQUE KEY `type_17` (`type`),
  UNIQUE KEY `type_18` (`type`),
  UNIQUE KEY `type_19` (`type`),
  UNIQUE KEY `type_20` (`type`),
  UNIQUE KEY `type_21` (`type`),
  UNIQUE KEY `type_22` (`type`),
  UNIQUE KEY `type_23` (`type`),
  UNIQUE KEY `type_24` (`type`),
  UNIQUE KEY `type_25` (`type`),
  UNIQUE KEY `type_26` (`type`),
  UNIQUE KEY `type_27` (`type`),
  UNIQUE KEY `type_28` (`type`),
  UNIQUE KEY `type_29` (`type`),
  UNIQUE KEY `type_30` (`type`),
  UNIQUE KEY `type_31` (`type`),
  UNIQUE KEY `type_32` (`type`),
  UNIQUE KEY `type_33` (`type`),
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `reviews_ibfk_35` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_36` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_37` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_38` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_39` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `reviews_ibfk_41` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_42` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_43` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_44` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_45` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_46` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_47` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_48` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_49` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_5` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_50` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_51` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_52` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_53` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_54` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_55` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_56` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_57` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_58` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_59` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_6` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_60` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_61` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_62` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_63` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_64` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_65` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_66` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_67` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_68` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_69` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_7` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_70` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_71` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_72` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_73` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reviews_ibfk_74` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
